...
import com.charlsgod.moviestest.databinding.ActivityMainBinding
import com.charlsgod.moviestest.util.PREF_MODE_KEY
    ...
    private fun onDestinationChanged(toolbar: Toolbar) {
        navController.addOnDestinationChangedListener { _, navDestination, _ ->
            when (navDestination.id) {
                ...
                R.id.nav_favourites -> toolbar.visibility = View.GONE
