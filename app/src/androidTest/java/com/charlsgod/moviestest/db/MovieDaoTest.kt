...
import com.charlsgod.moviestest.util.DEFAULT_SORT
import com.charlsgod.moviestest.util.POPULARITY_SORT
import com.charlsgod.moviestest.util.SortUtil
...
class MovieDaoTest : LocalDatabase() {
    ...
    fun insertAndLoadList() = runBlockingTest {
        ...
        val sortType: SortUtil.Companion.MovieSortType =
            SortUtil.Companion.MovieSortType.valueOf(POPULARITY_SORT)
