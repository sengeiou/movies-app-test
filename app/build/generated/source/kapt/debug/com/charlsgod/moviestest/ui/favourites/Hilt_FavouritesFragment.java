...
public abstract class Hilt_FavouritesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouritesFragment() {
    super();
  }

  Hilt_FavouritesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((FavouritesFragment_GeneratedInjector) this.generatedComponent()).injectFavouritesFragment(UnsafeCasts.<FavouritesFragment>unsafeCast(this));
  }
